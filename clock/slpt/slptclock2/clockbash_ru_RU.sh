...
slpt set_pic_grp week_nums/ week_ru_RU/    #将当前目录下的week_en_US目录内的0-7数字图片数据 加载到week_nums中（显示星期几）
...
slpt set_view_int week-en-view center-hor 1 start-y 165 #设置星期显示的位置
